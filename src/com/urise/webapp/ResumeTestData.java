...
public class ResumeTestData {
    ...
    public static Resume fillResume(String uuid, String fullName) {
        ...
        resume.setSection(SectionType.EXPERIENCE, new OrganizationSection(new Organization("AvtoVaz", null,
                ...
                new Organization.Experience(YearMonth.of(2005, 7), "engineer", "make a smart face"))));
    ...
    public static void main(String[] args) {
        ...
        Organization.Experience javaOnlineExp = new Organization.Experience(YearMonth.of(2013, 10), YearMonth.now(), "Автор проекта.", "Создание, организация и проведение Java онлайн проектов и стажировок.");
        Organization.Experience wrikeExp = new Organization.Experience(YearMonth.of(2014, 10), YearMonth.of(2016, 1), "Старший разработчик (backend)", "Проектирование и разработка " +
                ...
                "OAuth2, JWT SSO.");
        Organization.Experience ritCenterExp = new Organization.Experience(YearMonth.of(2012, 4), YearMonth.of(2014, 10), "Java архитектор", "Организация процесса разработки " +
        ...
        Organization.Experience luxoftExp = new Organization.Experience(YearMonth.of(2010, 12), YearMonth.of(2012, 4), "Ведущий программист", "Участие в проекте Deutsche Bank CRM (WebLogic, Hibernate, " +
        ...
        Organization.Experience yotaExp = new Organization.Experience(YearMonth.of(2008, 6), YearMonth.of(2010, 12), "Ведущий специалист", "Дизайн и имплементация Java EE фреймворка для отдела " +
        ...
        Organization.Experience enkataExp = new Organization.Experience(YearMonth.of(2007, 3), YearMonth.of(2008, 6), "Разработчик ПО", "Реализация клиентской (Eclipse RCP) и серверной (JBoss 4.2, " +
                "Hibernate 3.0, Tomcat, JMS) частей кластерного J2EE приложения (OLAP, Data mining).");
        Organization.Experience siemensExp = new Organization.Experience(YearMonth.of(2005, 1), YearMonth.of(2007, 2), "Разработчик ПО", "Разработка информационной модели, проектирование интерфейсов, " +
                "реализация и отладка ПО на мобильной IN платформе Siemens @vantage (Java, Unix).");
        Organization.Experience alcatelExp = new Organization.Experience(YearMonth.of(1997, 9), YearMonth.of(2005, 1), "Инженер по аппаратному и программному тестированию", "Тестирование, отладка, " +
        ...
        Organization.Experience courseraExp = new Organization.Experience(YearMonth.of(2013, 3), YearMonth.of(2013, 5), "\t\"Functional Programming Principles in Scala\" by Martin Odersky", null);
        Organization.Experience luxoftEduExp = new Organization.Experience(YearMonth.of(2011, 3), YearMonth.of(2011, 4), "Курс \"Объектно-ориентированный анализ ИС. Концептуальное моделирование на UML.\"",
                null);
        Organization.Experience siemensEduExp = new Organization.Experience(YearMonth.of(2005, 1), YearMonth.of(2005, 4), "3 месяца обучения мобильным IN сетям (Берлин)", null);
        Organization.Experience alcatelEduExp = new Organization.Experience(YearMonth.of(1997, 9), YearMonth.of(1998, 3), "6 месяцев обучения цифровым телефонным сетям (Москва)", null);
        Organization.Experience graduateExp = new Organization.Experience(YearMonth.of(1993, 9), YearMonth.of(1996, 7), "Аспирантура (программист С, С++)", null);
        Organization.Experience engineerExp = new Organization.Experience(YearMonth.of(1987, 9), YearMonth.of(1993, 7), "\tИнженер (программист Fortran, C)", null);
        Organization.Experience mftiExp = new Organization.Experience(YearMonth.of(1984, 9), YearMonth.of(1987, 6), "\tЗакончил с отличием", null);
